...
<div class="invoice-box">
        ...
        <table>
          <tr>
            <td>
                ...
                <span style="    font-size: 25px;">To:</span> <span style="    font-size: 18px;">{{$payment->first_name}}</span><br>
                <span style="font-weight: 600;">Email:</span> <span>{{$payment->email}}</span><br>
                <span style="font-weight: 600;">Phone:</span><span>{{$payment->country_code.''.$payment->number}}</span>
             </div>
            </td>
            <td class="title">
    ...
    <table class="invoice_main_table"  cellpadding="0" cellspacing="0">
        <tr class="heading">
           ...
           <tbody>
            ...
            <tr class="item">
            <td style="font-size: 24px;font-weight:bold;padding: 5px;" colspan="3"> Fujtown E-Service  </td>
            </tr>
            <tr class="item">
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr class="item">
            <td class="description"> Consolidated Call  Business set-up </td>
       ...
       <tfoot>
        <tr class="total">
            ...
            <td colspan="2"> Total: 	 {{number_format($payment->amount, 2, '.', ',') . ' '. $payment->currency}} </td>
          </tr>
          <tr class="total">
            <td class="payment-link">
               <span style="    background: #3b4e87;display: block;color: white;">Payment Link below:- </span>
                <span style="    padding: 20px 5px;display: block;"><a href="https://fujtrade.com/invoice_status/{{$payment->ch_id}}">https://fujtrade.com/invoice_status</a></span>
            </td>
            <td colspan="2" style="text-align: center;padding-top: 15px;"> Make all cheque payable to <br><span>FUJTOWN</span></td>
 ...
 <script>
     $(document).ready(function(){
          ...
          const descriptions = [
            "Initial Trading Strategy Session",
            "Comprehensive Market Analysis Consultation",
            "Investment Portfolio Review & Recommendations",
            "Advanced Trading Techniques and Tools Overview",
            "Risk Management and Asset Allocation Consultation",
            "Custom Trading Plan Development Session",
            "In-depth Analysis of Current Market Trends",
            "Expert Consultation on Forex Trading Strategies",
            "Personalized Investment Advice for Stock Trading",
            "Technical Analysis and Charting Consultation"
        ];
