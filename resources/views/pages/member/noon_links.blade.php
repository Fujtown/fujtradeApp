...
@push('scripts')
 ...
 var table=$('#datatable-buttons').DataTable({
    "dom": 'Bfrtip',
            ...
            $.ajax({
                url: '{{ url('coffee/member/get_all_noon_links') }}',
                type: 'GET',
                data: ajaxData,
        ...
        columns: [
            ...
            { data: null, render: function (data, type, row, meta) {
                return '<button class="copy-url" style="border: none;cursor: pointer;" data-url="'+row.url+'"><i  class="fa fa-copy text-info "></i></button>';
            }}
