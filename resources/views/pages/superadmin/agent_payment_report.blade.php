                ...
                <div class="page-title-box">
                    <div class="btn-group pull-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item active">Agent Payment Report</li>
                        </ol>
                    </div>
                    <h4 class="page-title">List Of Agent Payment Report</h4>
            ...
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Agent Payment Report</h4>
                                <div class="row">
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-3">
                                        <h6 class="sub-title my-3">Filter By Agent</h6>
                                        <select name="agent" class="form-control agent" id="">
     ...
     var table=$('#datatable-buttons').DataTable({
        "dom": 'Bfrtip',
                ...
                // console.log(status)
                        ...
                        if (minDate && maxDate && agent =='') {
                            ajaxData.min_date = minDate;
                            ajaxData.max_date = maxDate;
                        }
                        else if(minDate && maxDate && agent) {
                            ajaxData.min_date = minDate;
                            ajaxData.max_date = maxDate;
                            ajaxData.agent = agent;
                        }
                        else if(agent)
                        {
                            ajaxData.agent = agent;
                ...
                $.ajax({
                    url: '{{ url('coffee/get_payment_by_agent') }}',
                    type: 'GET',
                    data: ajaxData,
