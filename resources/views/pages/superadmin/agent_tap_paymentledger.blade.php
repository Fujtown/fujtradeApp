                ...
                <div class="page-title-box">
                    <div class="btn-group pull-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item active">Agent Tap Payment</li>
                        </ol>
                    </div>
                    <h4 class="page-title">List Of TAP Pyaments By Ledger</h4>
            ...
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">List Of TAP Pyaments By Ledger</h4>
                                <div class="row">
                                    <div class="col-md-5">
...
<script>
 ...
 var table=$('#datatable-buttons').DataTable({
    "dom": 'Bfrtip',
            ...
            $.ajax({
                url: '{{ url('coffee/get_all_tap_paymentsAgentLedger') }}',
                type: 'GET',
                data: ajaxData,
