        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">List of Agents</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">List Of Agents</h4>
 ...
 <script>
    ...
    "dom": 'Bfrtip',
        ...
        columns: [
            ...
            { data: 'email'},
            { data: null, render: function (data, type, row, meta) {
                return '<button type="button" class="edit_btn"  data-toggle="modal" data-target="#exampleModalform" data-id="'+row.id+'" style="border: none;cursor: pointer;"><i class="fa fa-edit text-success"></i></button> | <button class="delete-btn" data-id="'+row.id+'" style="border: none;cursor: pointer;"><i class="fa fa-trash text-danger "  ></i></button>';
            }}
