        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">List Of Foloosi Pyaments</h4>
            ...
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">List Of Foloosi Pyaments</h4>
                                <div class="row">
                                    <div class="col-md-5">
...
var formattedDate = year + '-' + month + '-' + day + ' ' + hours + ':' + minutes + ':' + seconds + ' ' + ampm;
 ...
 var table=$('#datatable-buttons').DataTable({
    "dom": 'Bfrtip',
            ...
            $.ajax({
                url: '{{ url('coffee/get_all_foloosi_payments') }}',
                type: 'GET',
                data: ajaxData,
