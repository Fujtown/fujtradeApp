                ...
                <div class="page-title-box">
                    <div class="btn-group pull-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item active">All Kyc's</li>
                        </ol>
                    </div>
                    <h4 class="page-title">List of Kyc's</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">List Of Kyc's</h4>
    ...
    $(document).on('click','.delete-btn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ url('coffee/delete_kyc') }}', // Your API endpoint to delete the item
                        type: 'GET',
                        data: {
                            id: itemId,
