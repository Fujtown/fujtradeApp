        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">List Of Refunds Transactions</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">List Of Refunds Transactions</h4>
                                <div class="row">
                                    <div class="col-md-5">
...
<script>
 ...
 var table=$('#datatable-buttons').DataTable({
    "dom": 'Bfrtip',
            ...
            $.ajax({
                url: '{{ url('coffee/fetch_all_refunds') }}',
                type: 'GET',
                data: ajaxData,
        ...
        columns: [
            ...
            { data: null, render: function(data, type, row) {
                ...
                return '<ul><li> Refund Amount : <b>'+ row.ref_amount + ' ' + row.ref_currency +'</b></li><li> Customer Requested Amount : <b>'+ row.req_amount + ' ' + row.req_currency +'</b></li><li> Transaction Amount : <b>'+ row.transaction_amount + ' ' + row.transaction_currency +'</b></li></ul>'
            }},
        ...
        // order: [[1, 'desc']] // Optional: if you want to order by a specific column by default
                ...
                $('#sync_data').click(function() {
                    ...
                    $.ajax({
                        url: '{{ url('coffee/get_all_tap_refunds') }}', // Your Node.js endpoint
                        type: 'GET',
