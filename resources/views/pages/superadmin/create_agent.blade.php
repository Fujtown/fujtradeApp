                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="createAgent" action="">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="email" class="form-control" type="text" value="" id="amount">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-4 col-form-label">Password</label>
                                    <div class="col-sm-8">
                                        <input name="password" class="form-control" type="password" value="" id="amount">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-4 col-form-label">Limit Amount</label>
                                    <div class="col-sm-8">
                                        <input name="limit_amount" value=""  class="form-control" type="text" value="" id="limit_amount">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                           <input type="button" class="btn btn-info generate" value="Create Now">
                                        </div>
                                    </div>
                                </form>
...
<script>
     //Fetch data from Payment gateway and store into database
       $('.generate').click(function() {
                    ...
                    var data = new FormData(document.getElementById("createAgent"));

                    $.ajax({
                        headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                         url: '{{ url('coffee/store_agent') }}',
                         type: "POST",
                        data: data,
                        processData: false,
                        contentType: false,
