...
@push('scripts')
 ...
 var table=$('#datatable-buttons').DataTable({
    "dom": 'Bfrtip',
            ...
            $.ajax({
                url: '{{ url('coffee/get_all_noon_links') }}',
                type: 'GET',
                data: ajaxData,
          ...
          $(document).on('click','.delete-btn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ url('coffee/delete_noon_link') }}', // Your API endpoint to delete the item
                        type: 'GET',
                        data: {
                            id: itemId,
        ...
        $(document).on('click','.edit_btn',function() {
            ...
            $('.link_id').val(id);
            $.ajax({
                url: '{{ url('coffee/get_noon_link_detail') }}',
                type: 'GET',
                data: {
                      id: id,
                        },
        ...
        $('.update-btn').click(function() {
                    ...
                    $.ajax({
                         url: '{{ url('coffee/update_noon_link') }}',
                         type: "POST",
                        data: data,
                        processData: false,
                        contentType: false,
