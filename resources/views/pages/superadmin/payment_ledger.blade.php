        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">List Of Payments</h4>
            ...
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">List Of Payments</h4>
                                <div class="row">
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-3">
                                        <h6 class="sub-title my-3">Filter By Payment Gateway</h6>
                                        <select name="" class="form-control status" id="">
                                            <option value="">Select Payment</option>
                                            <option value="all_tap_payment">TAP</option>
                                            <option value="foloosis">FOLOOSI</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
...
@push('scripts')
 ...
 <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
    ...
    <script>
       ...
       function foloosiFormatDate(formdate)
       {
           // Your date string
        const dateString = formdate;
        
        // Create a date object using the date string
        const date = new Date(dateString);
        
        // Define a function to add leading zeros to numbers less than 10
        function pad(number) {
          return (number < 10 ? '0' : '') + number;
        }
        
        // Define a function to format the date as MM/DD/YYYY
     ...
     var table=$('#datatable-buttons').DataTable({
        "dom": 'Bfrtip',
                ...
                $.ajax({
                    url: '{{ url('coffee/get_all_paymentsLedger') }}',
                    type: 'GET',
                    data: ajaxData,
            ...
            columns: [
                ...
                return row.full_name !=null ? row.full_name : '---' + '<br>' +
                       row.email
            }},
                 { data: 'source_table', render: function(data, type, row) {
                     switch (data) {
                        case 'all_tap_payment':
                            return 'TAP';
                        case 'noon_transactions':
                            return 'NOON';
                        case 'foloosi':
                            return 'FOLOOSI';
                        default:
                            return 'Unknown'; // Optional: handle unexpected data
                    }
            ...
            if (data.source_table == 'all_tap_payment') {
                // If the source table is 'all_tap_payment', make the row light orange
                $(row).css('background-color', '#ffa50026');
            }  else if (data.source_table == 'noon_transactions') {
                // If the source table is 'all_tap_payment', make the row light orange
                $(row).css('background-color', 'rgba(166, 105, 168, 0.3)');
            }   else {
                // Otherwise, make the row light green
                $(row).css('background-color', '#90ee9066');
            }
        },
