            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Today Transactions</h4>
                     <form <form action="{{ route('coffee.todayTransaction') }}" method="GET">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <a href="{{ route('coffee.todayTransaction') }}" class="btn btn-warning" id="reset">Reset</a>
                                    </div>
                                       </div>
                            ...
                            <div class="card-body">
                                <h4 class="mt-0 header-title">TAP Transactions</h4>
                                  ...
                                  <div class="row">
                                    ...
                                    $urlWithParams = url('coffee/exportTapTransactionsPdf', $queryParams);
                                     $urlWithParamsexcel = url('coffee/exportExcelTap', $queryParams);
                                @endphp
            ...
            <div class="col-xl-6">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Noon Transactions</h4>
                                                                @php
                                    $queryParams = [];
                                    if (request()->has('start')) {
                                        $queryParams['start'] = request()->get('start');
                                    }
                                    $urlWithParams = url('coffee/exportFoloosiTransactionsPdf', $queryParams);
                                     $urlWithParamsexcel = url('coffee/exportFoloosiExcelTap', $queryParams);
                                @endphp
